...
enum Specification {
  ...
  bsc(
    ...
    aAnchor: Coord(32.50, 0),
    bAnchor: Coord(0, -27.50),
    cAnchor: Coord(32.50, 0),
  ...
  cte(
    ...
    aAnchor: Coord(23.75, 0),
    bAnchor: Coord(0, -27.50),
    cAnchor: Coord(23.75, 0),
  ...
  csv(
    ...
    aAnchor: Coord(35.00, 0),
    bAnchor: Coord(0, -27.50),
    cAnchor: Coord(35.00, 0),
  ...
  obj(
    ...
    aAnchor: Coord(27.50, 0),
    bAnchor: Coord(0, -27.50),
    cAnchor: Coord(27.50, 0),
  ...
  const Specification({
    required this.path,
    required this.aAnchor,
    required this.bAnchor,
    required this.cAnchor,
