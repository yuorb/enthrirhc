...
enum CoreLetter {
  f(
    ...
    start: Anchor(AnchorOrientation.right, 50, -25),
    end: Anchor(AnchorOrientation.down, 40, 25),
  ),
  v(
    letter: Letter(
      Phoneme.v,
    ...
    start: Anchor(AnchorOrientation.right, 50, -25),
    end: Anchor(AnchorOrientation.down, 35, 25),
  ),
  c(
    letter: Letter(
      Phoneme.c,
    ...
    start: Anchor(AnchorOrientation.up, 0.00, -25.00),
    end: Anchor(AnchorOrientation.right, 40, 35),
  ),
  dz(
    letter: Letter(
      Phoneme.dz,
    ...
    start: Anchor(AnchorOrientation.up, 10, -25),
    end: Anchor(AnchorOrientation.right, 45, 35),
  ),
  t(
    letter: Letter(
      Phoneme.t,
    ...
    start: Anchor(AnchorOrientation.right, 40, -25),
    end: Anchor(AnchorOrientation.down, 10, 25),
  ),
  d(
    letter: Letter(
      Phoneme.d,
    ...
    start: Anchor(AnchorOrientation.right, 40, -25),
    end: Anchor(AnchorOrientation.down, 20, 25),
  ),
  sh(
    letter: Letter(
      Phoneme.sh,
    ...
    start: Anchor(AnchorOrientation.up, 30, -25),
    end: Anchor(AnchorOrientation.right, 30, 35),
  ),
  ch(
    letter: Letter(
      Phoneme.ch,
  ...
  l(
    ...
    start: Anchor(AnchorOrientation.up, 5, -25),
    end: Anchor(AnchorOrientation.right, 40, 35),
  ),
  m(
    letter: Letter(
    ...
    start: Anchor(AnchorOrientation.up, 0, -25),
    end: Anchor(AnchorOrientation.lowerRight, 37.50, 27.50),
  ),
  hs(
    letter: Letter(
      Phoneme.hs,
    ...
    start: Anchor(AnchorOrientation.right, 63.7, -25),
    end: Anchor(AnchorOrientation.lowerRight, 33.85, 27.50),
  ),
  h(
    letter: Letter(
      Phoneme.h,
    ...
    start: Anchor(AnchorOrientation.up, 0, -25),
    end: Anchor(AnchorOrientation.down, 45, 25),
  ),
  p(
    letter: Letter(
      Phoneme.p,
  ...
  k(
    ...
    start: Anchor(AnchorOrientation.right, 65.65, -25.03),
    end: Anchor(AnchorOrientation.lowerRight, 56.30, 27.52),
  ),
  b(
    letter: Letter(
      Phoneme.b,
    ...
    start: Anchor(AnchorOrientation.right, 49.4, -25),
    end: Anchor(AnchorOrientation.down, 39.4, 25),
  ),
  dh(
    letter: Letter(
      Phoneme.dh,
    ...
    start: Anchor(AnchorOrientation.right, 50, -24.92),
    end: Anchor(AnchorOrientation.lowerRight, 37.85, 27.28),
  ),
  g(
    letter: Letter(
      Phoneme.g,
    ...
    start: Anchor(AnchorOrientation.right, 65.65, -24.93),
    end: Anchor(AnchorOrientation.lowerRight, 69.30, 27.52),
  ),
  hl(
    letter: Letter(
      Phoneme.hl,
    ...
    start: Anchor(AnchorOrientation.up, 0, -25),
    end: Anchor(AnchorOrientation.lowerRight, 42.45, 27.50),
  ),
  n(
    letter: Letter(
      Phoneme.n,
    ...
    start: Anchor(AnchorOrientation.up, 0, -24.92),
    end: Anchor(AnchorOrientation.lowerRight, 37.70, 27.42),
  ),
  ng(
    letter: Letter(
      Phoneme.ng,
    ...
    start: Anchor(AnchorOrientation.up, 8.45, -25.05),
    end: Anchor(AnchorOrientation.lowerRight, 34.20, 27.55),
  ),
  r(
    letter: Letter(
      Phoneme.r,
    ...
    start: Anchor(AnchorOrientation.upperLeft, 0, -27.50),
    end: Anchor(AnchorOrientation.right, 40, 35),
  ),
  gr(
    letter: Letter(
    ...
    start: Anchor(AnchorOrientation.upperLeft, 0, -27.47),
    end: Anchor(AnchorOrientation.right, 38, 35.03),
  ),
  s(
    letter: Letter(
      Phoneme.s,
    ...
    start: Anchor(AnchorOrientation.up, 45, -24.97),
    end: Anchor(AnchorOrientation.lowerRight, 37.45, 27.47),
  ),
  th(
    letter: Letter(
      Phoneme.th,
    ...
    start: Anchor(AnchorOrientation.right, 50, -25.05),
    end: Anchor(AnchorOrientation.lowerRight, 40.60, 27.55),
  ),
  x(
    letter: Letter(
      Phoneme.x,
    ...
    start: Anchor(AnchorOrientation.right, 65.65, -25.03),
    end: Anchor(AnchorOrientation.lowerRight, 52.60, 27.52),
  ),
  z(
    letter: Letter(
      Phoneme.z,
    ...
    start: Anchor(AnchorOrientation.upperLeft, 12.65, -27.72),
    end: Anchor(AnchorOrientation.lowerRight, 33.10, 27.72),
  ),
  zh(
    letter: Letter(
      Phoneme.zh,
    ...
    start: Anchor(AnchorOrientation.upperLeft, 9.45, -27.53),
    end: Anchor(AnchorOrientation.right, 40.00, 35.03),
  );
