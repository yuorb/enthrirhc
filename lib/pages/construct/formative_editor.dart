        ...
        children: [
          ...
          PopupMenuButton<Stem>(
            ...
            child: ListTile(
              ...
              tileColor: widget.formative.stem != Stem.s1
          ...
          PopupMenuButton<Specification>(
            ...
            child: ListTile(
              ...
              tileColor: widget.formative.specification != Specification.bsc
                  ? Theme.of(context).colorScheme.primaryContainer
                  : null,
            ),
          ),
          ...
          PopupMenuButton<Version>(
            ...
            child: ListTile(
              ...
              tileColor: widget.formative.version != Version.prc
                  ? Theme.of(context).colorScheme.primaryContainer
                  : null,
            ),
          ),
          PopupMenuButton<Function$>(
            ...
            child: ListTile(
              ...
              tileColor: widget.formative.function != Function$.sta
                  ? Theme.of(context).colorScheme.primaryContainer
                  : null,
            ),
          ),
          PopupMenuButton<Context>(
            ...
            child: ListTile(
              ...
              tileColor: widget.formative.context != Context.exs
                  ? Theme.of(context).colorScheme.primaryContainer
                  : null,
            ),
          ),
          ...
          PopupMenuButton<Affiliation>(
            ...
            child: ListTile(
              ...
              tileColor: widget.formative.affiliation == Affiliation.csl
                  ? null
                  : Theme.of(context).colorScheme.primaryContainer,
            ),
          ),
          PopupMenuButton<Plexity>(
            ...
            child: ListTile(
              ...
              tileColor: widget.formative.configuration.plexity == Plexity.u
                  ? null
                  : Theme.of(context).colorScheme.primaryContainer,
            ),
          ),
          ...
          PopupMenuButton<Extension>(
            ...
            child: ListTile(
              ...
              tileColor: widget.formative.extension == Extension.del
                  ? null
                  : Theme.of(context).colorScheme.primaryContainer,
            ),
          ),
          PopupMenuButton<Perspective>(
            ...
            child: ListTile(
              ...
              tileColor: widget.formative.perspective == Perspective.m
                  ? null
                  : Theme.of(context).colorScheme.primaryContainer,
            ),
          ),
          PopupMenuButton<Essence>(
            ...
            child: ListTile(
              ...
              tileColor: widget.formative.essence == Essence.nrm
                  ? null
                  : Theme.of(context).colorScheme.primaryContainer,
            ),
          ),
          ...
          widget.formative.formativeType.isCaseScope()
              ? PopupMenuButton<Cn>(
                  ...
                  child: ListTile(
                    ...
                    tileColor: widget.formative.cn == Cn.cn1
                        ? null
                        : Theme.of(context).colorScheme.primaryContainer,
                  ),
                )
