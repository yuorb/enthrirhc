...
class ComponentC {
  ...
  const ComponentC({this.separability, this.similarity});

  String id() {
    if (separability != null && similarity != null) {
      return '${separability!.name}_${similarity!.name}';
    } else {
      return 'empty_separability_and_similarity';
    }
  }

  String path() {
    if (similarity == null || separability == null) {
      return '';
    }
    return switch (similarity!) {
      Similarity.s => switch (separability!) {
        Separability.s =>
          "M -32.50 12.50 L -12.50 32.50 -5.00 25.00 -25.00 5.00 -32.50 12.50 Z",
        Separability.c =>
          "M -20.00 0.00 L -30.00 10.00 -30.00 35.00 -20.00 25.00 -20.00 0.00 Z",
        Separability.f =>
          "M -10.00 30.00 L 0.00 20.00 -30.00 20.00 -40.00 30.00 -10.00 30.00 Z",
      },
